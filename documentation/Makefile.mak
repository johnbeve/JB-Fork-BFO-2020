...
# Project essentials
config.ONTOLOGY_FILE	:= implementations/BFO-OWL/bfo-core.owl
config.ONTOLOGY_PREFIX	:= BFO
config.ONTOLOGY-IRI		:= http://purl.obolibrary.org/obo/bfo-core.owl
...
config.SOURCE_DIR		:= implementations/BFO-OWL
